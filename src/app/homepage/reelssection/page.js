...
const ReelsSection = () => {
  return (
    <div className="my-16 md:my-10 w-full overflow-clip">
      <p className="text-center font-medium text-background">REELS SECTION</p>
      <div className="text-3xl font-semibold text-center mt-3 mb-8 text-background">
        Title
      </div>
      <div
        id="scroll-container"
        className="mx-3 w-full overflow-x-auto scroll-smooth flex gap-2"
      >
