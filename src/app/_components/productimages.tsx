...
export default function ProductImages({ images = [], product }) {
    ...
    const safeImages = Array.isArray(images) && images.length > 0 ? images : ["/Assets/hari_krishna.png"];
            ...
            <div className="flex gap-2 mt-4">
                {safeImages.map((img, index) => (
                    <button
                        ...
                        className={`w-16 h-16 border rounded-md overflow-hidden ${selectedImage === index ? "ring-2 ring-blue-500" : ""}`}
                    >
                        <img
                            src={img}
